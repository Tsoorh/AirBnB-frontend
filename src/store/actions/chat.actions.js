...
import { ADD_CHAT, ADD_NEW_MSG, SET_CHATID, SET_CURRENT_CHAT, UPDATE_CHAT } from "../reducers/chat.reducer";
...
//         store.dispatch({ type: SET_CURRENT_MESSAGES, messages })
//     } catch (err) {
...
//     }
// }
export async function setChatId(participants) { // participants is an array of userIds
    try{
        console.log("🚀 ~ setChatId ~ participants:", participants)
